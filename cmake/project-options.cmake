...
if(AUDIO_UTILS_USE_SANITIZER)
    if(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
        ...
        target_compile_options(audioutils_options INTERFACE $<$<CONFIG:Debug>:-fsanitize=address>)
        target_link_options(audioutils_options INTERFACE $<$<CONFIG:Debug>:-fsanitize=address>)
    endif()
endif()
...
if(LIBCPP)
    if(AUDIO_UTILS_ENABLE_HARDENING)
...
if(MSVC_STL)
    if(AUDIO_UTILS_ENABLE_HARDENING)
        ...
        target_compile_definitions(
            audioutils_options INTERFACE $<$<CONFIG:Debug>:_MSVC_STL_HARDENING=1>
